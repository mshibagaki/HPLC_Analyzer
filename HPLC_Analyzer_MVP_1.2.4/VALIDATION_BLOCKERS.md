...
- The non-GUI suite passed 123 tests for the Issue #124 candidate, including normalized backend-neutral overview full/detail-window state, bounded home/back/forward history, axis-pan state/calculations, immutable pointer coordinates and hit targets, optional-renderer isolation/pinning, backend-neutral scene contracts, update metadata, project migrations, numerical invariance, import, presets, and release-source contracts.
- The Windows/PySide6 offscreen GUI suite passed 118 tests for the Issue #124 candidate, including overview/detail patch updates and click navigation, toolbar history, raw and normalized pan paths, marker/annotation targets, normalized pointer paths, and the optional PyQtGraph consumer's independent X/Y1/Y2/B% ranges, overview detail window, and non-empty 800×500 Qt snapshot.
